$(document).ready(function() {
    ...
    function q() {
        let q, f;
        for (let e = 1; e < 23; e++)
            q = +document.querySelector(`#point-${e}`).scrollHeight / 3,
            f = document.querySelector(`#point-${e}`).attributes[1].value.split(" "),
            1 == document.querySelector(`#point-${e}`).textContent.length ? document.querySelector(`#point-${e}`).attributes[1].value = `translate(${+t[e] + q / 3 * 1.3} ${+f[1].match(/[0-9/.]+/)})` : document.querySelector(`#point-${e}`).attributes[1].value = `translate(${+t[e]} ${+f[1].match(/[0-9/.]+/)})`;
        1 == document.querySelector("#point-bl1").textContent.length ? (q = +document.querySelector("#point-bl1").scrollHeight / 3,
        f = document.querySelector("#point-bl1").attributes[1].value.split(" "),
        document.querySelector("#point-bl1").attributes[1].value = `translate(${+e + q / 2} ${+f[1].match(/[0-9/.]+/)})`) : (q = +document.querySelector("#point-bl1").scrollHeight / 3,
        f = document.querySelector("#point-bl1").attributes[1].value.split(" "),
        document.querySelector("#point-bl1").attributes[1].value = `translate(${+e} ${+f[1].match(/[0-9/.]+/)})`),
        1 == document.querySelector("#point-bl2").textContent.length ? (q = +document.querySelector("#point-bl2").scrollHeight / 3,
        f = document.querySelector("#point-bl2").attributes[1].value.split(" "),
        document.querySelector("#point-bl2").attributes[1].value = `translate(${+n + q / 2} ${+f[1].match(/[0-9/.]+/)})`) : (q = +document.querySelector("#point-bl2").scrollHeight / 3,
        f = document.querySelector("#point-bl2").attributes[1].value.split(" "),
        document.querySelector("#point-bl2").attributes[1].value = `translate(${+n} ${+f[1].match(/[0-9/.]+/)})`),
        1 == document.querySelector("#point-br2").textContent.length ? (q = +document.querySelector("#point-br2").scrollHeight / 3,
        f = document.querySelector("#point-br2").attributes[1].value.split(" "),
        document.querySelector("#point-br2").attributes[1].value = `translate(${+r + q / 2} ${+f[1].match(/[0-9/.]+/)})`) : (q = +document.querySelector("#point-br2").scrollHeight / 3,
        f = document.querySelector("#point-br2").attributes[1].value.split(" "),
        document.querySelector("#point-br2").attributes[1].value = `translate(${+r} ${+f[1].match(/[0-9/.]+/)})`),
        1 == document.querySelector("#point-br1").textContent.length ? (q = +document.querySelector("#point-br1").scrollHeight / 3,
        f = document.querySelector("#point-br1").attributes[1].value.split(" "),
        document.querySelector("#point-br1").attributes[1].value = `translate(${+o + q / 2} ${+f[1].match(/[0-9/.]+/)})`) : (q = +document.querySelector("#point-br1").scrollHeight / 3,
        f = document.querySelector("#point-br1").attributes[1].value.split(" "),
        document.querySelector("#point-br1").attributes[1].value = `translate(${+o} ${+f[1].match(/[0-9/.]+/)})`),
        1 == document.querySelector("#point-tl1").textContent.length ? (q = +document.querySelector("#point-tl1").scrollHeight / 3,
        f = document.querySelector("#point-tl1").attributes[1].value.split(" "),
        document.querySelector("#point-tl1").attributes[1].value = `translate(${+l + q / 2} ${+f[1].match(/[0-9/.]+/)})`) : (q = +document.querySelector("#point-tl1").scrollHeight / 3,
        f = document.querySelector("#point-tl1").attributes[1].value.split(" "),
        document.querySelector("#point-tl1").attributes[1].value = `translate(${+l} ${+f[1].match(/[0-9/.]+/)})`),
        1 == document.querySelector("#point-tl2").textContent.length ? (q = +document.querySelector("#point-tl2").scrollHeight / 3,
        f = document.querySelector("#point-tl2").attributes[1].value.split(" "),
        document.querySelector("#point-tl2").attributes[1].value = `translate(${+c + q / 2} ${+f[1].match(/[0-9/.]+/)})`) : (q = +document.querySelector("#point-tl2").scrollHeight / 3,
        f = document.querySelector("#point-tl2").attributes[1].value.split(" "),
        document.querySelector("#point-tl2").attributes[1].value = `translate(${+c} ${+f[1].match(/[0-9/.]+/)})`),
        1 == document.querySelector("#point-tr2").textContent.length ? (q = +document.querySelector("#point-tr2").scrollHeight / 3,
        f = document.querySelector("#point-tr2").attributes[1].value.split(" "),
        document.querySelector("#point-tr2").attributes[1].value = `translate(${+u + q / 2} ${+f[1].match(/[0-9/.]+/)})`) : (q = +document.querySelector("#point-tr2").scrollHeight / 3,
        f = document.querySelector("#point-tr2").attributes[1].value.split(" "),
        document.querySelector("#point-tr2").attributes[1].value = `translate(${+u} ${+f[1].match(/[0-9/.]+/)})`),
        1 == document.querySelector("#point-tr1").textContent.length ? (q = +document.querySelector("#point-tr1").scrollHeight / 3,
        f = document.querySelector("#point-tr1").attributes[1].value.split(" "),
        document.querySelector("#point-tr1").attributes[1].value = `translate(${+i + q / 2} ${+f[1].match(/[0-9/.]+/)})`) : (q = +document.querySelector("#point-tr1").scrollHeight / 3,
        f = document.querySelector("#point-tr1").attributes[1].value.split(" "),
        document.querySelector("#point-tr1").attributes[1].value = `translate(${+i} ${+f[1].match(/[0-9/.]+/)})`),
        1 == document.querySelector("#otp-zemly").textContent.length ? (q = +document.querySelector("#otp-zemly").scrollHeight / 3,
        f = document.querySelector("#otp-zemly").attributes[1].value.split(" "),
        document.querySelector("#otp-zemly").attributes[1].value = `translate(${+a + q / 2 - 1} ${+f[1].match(/[0-9/.]+/)})`) : (q = +document.querySelector("#otp-zemly").scrollHeight / 3,
        f = document.querySelector("#otp-zemly").attributes[1].value.split(" "),
        document.querySelector("#otp-zemly").attributes[1].value = `translate(${+a} ${+f[1].match(/[0-9/.]+/)})`),
        1 == document.querySelector("#otp-nebo").textContent.length ? (q = +document.querySelector("#otp-nebo").scrollHeight / 3,
        f = document.querySelector("#otp-nebo").attributes[1].value.split(" "),
        document.querySelector("#otp-nebo").attributes[1].value = `translate(${+y + q / 2 - 1} ${+f[1].match(/[0-9/.]+/)})`) : (q = +document.querySelector("#otp-nebo").scrollHeight / 3,
        f = document.querySelector("#otp-nebo").attributes[1].value.split(" "),
        document.querySelector("#otp-nebo").attributes[1].value = `translate(${+y} ${+f[1].match(/[0-9/.]+/)})`),
        1 == document.querySelector("#otp-sum-nz").textContent.length ? (q = +document.querySelector("#otp-sum-nz").scrollHeight / 3,
        f = document.querySelector("#otp-sum-nz").attributes[1].value.split(" "),
        document.querySelector("#otp-sum-nz").attributes[1].value = `translate(${+m + q / 2 - 1} ${+f[1].match(/[0-9/.]+/)})`) : (q = +document.querySelector("#otp-sum-nz").scrollHeight / 3,
        f = document.querySelector("#otp-sum-nz").attributes[1].value.split(" "),
        document.querySelector("#otp-sum-nz").attributes[1].value = `translate(${+m} ${+f[1].match(/[0-9/.]+/)})`),
        1 == document.querySelector("#otp-man").textContent.length ? (q = +document.querySelector("#otp-man").scrollHeight / 3,
        f = document.querySelector("#otp-man").attributes[1].value.split(" "),
        document.querySelector("#otp-man").attributes[1].value = `translate(${+s + q / 2 - 1} ${+f[1].match(/[0-9/.]+/)})`) : (q = +document.querySelector("#otp-man").scrollHeight / 3,
        f = document.querySelector("#otp-man").attributes[1].value.split(" "),
        document.querySelector("#otp-man").attributes[1].value = `translate(${+s} ${+f[1].match(/[0-9/.]+/)})`),
        1 == document.querySelector("#otp-woman").textContent.length ? (q = +document.querySelector("#otp-woman").scrollHeight / 3,
        f = document.querySelector("#otp-woman").attributes[1].value.split(" "),
        document.querySelector("#otp-woman").attributes[1].value = `translate(${+p + q / 2 - 1} ${+f[1].match(/[0-9/.]+/)})`) : (q = +document.querySelector("#otp-woman").scrollHeight / 3,
        f = document.querySelector("#otp-woman").attributes[1].value.split(" "),
        document.querySelector("#otp-woman").attributes[1].value = `translate(${+p} ${+f[1].match(/[0-9/.]+/)})`),
        1 == document.querySelector("#otp-sum-mw").textContent.length ? (q = +document.querySelector("#otp-sum-mw").scrollHeight / 3,
        f = document.querySelector("#otp-sum-mw").attributes[1].value.split(" "),
        document.querySelector("#otp-sum-mw").attributes[1].value = `translate(${+d + q / 2 - 1} ${+f[1].match(/[0-9/.]+/)})`) : (q = +document.querySelector("#otp-sum-mw").scrollHeight / 3,
        f = document.querySelector("#otp-sum-mw").attributes[1].value.split(" "),
        document.querySelector("#otp-sum-mw").attributes[1].value = `translate(${+d} ${+f[1].match(/[0-9/.]+/)})`),
        1 == document.querySelector("#otp-otp-du").textContent.length ? (q = +document.querySelector("#otp-otp-du").scrollHeight / 3,
        f = document.querySelector("#otp-otp-du").attributes[1].value.split(" "),
        document.querySelector("#otp-otp-du").attributes[1].value = `translate(${+x + q / 2 - 1.5} ${+f[1].match(/[0-9/.]+/)})`) : (q = +document.querySelector("#otp-otp-du").scrollHeight / 3,
        f = document.querySelector("#otp-otp-du").attributes[1].value.split(" "),
        document.querySelector("#otp-otp-du").attributes[1].value = `translate(${+(x - 1.5)} ${+f[1].match(/[0-9/.]+/)})`),
        1 == document.querySelector("#otp-otp-pl").textContent.length ? (q = +document.querySelector("#otp-otp-pl").scrollHeight / 3,
        f = document.querySelector("#otp-otp-pl").attributes[1].value.split(" "),
        document.querySelector("#otp-otp-pl").attributes[1].value = `translate(${+S + q / 2 - 1.5} ${+f[1].match(/[0-9/.]+/)})`) : (q = +document.querySelector("#otp-otp-pl").scrollHeight / 3,
        f = document.querySelector("#otp-otp-pl").attributes[1].value.split(" "),
        document.querySelector("#otp-otp-pl").attributes[1].value = `translate(${+(S - 1.5)} ${+f[1].match(/[0-9/.]+/)})`),
        q = 0,
        f = 0
    }
    function f(t) {
